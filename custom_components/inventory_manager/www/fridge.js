class InventoryManagerFridge extends HTMLElement {
  ...
  async _renameCategory(oldName) {
    ...
    try {
      await this._hass.callService('inventory_manager', 'rename_category', { old_name: oldName, new_name: newName, location: 'fridge' });
  ...
  async _renameZone(oldName) {
    ...
    try {
      await this._hass.callService('inventory_manager', 'rename_zone', { old_name: oldName, new_name: newName, location: 'fridge' });
